...
class TweetHeader: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        stack.anchor(top: topAnchor,
                     left: leftAnchor, paddingTop: 16, paddingLeft: 16)
        
        addSubview(captionLabel)
        captionLabel.anchor(top: stack.bottomAnchor,
                            left: leftAnchor,
                            right: rightAnchor, paddingTop: 12, paddingLeft: 16, paddingRight: 16)
        
        addSubview(dateLabel)
        dateLabel.anchor(top: captionLabel.bottomAnchor,
                         left: leftAnchor, paddingTop: 20, paddingLeft: 16)
    ...
    @objc func handleProfileImageTapped() {
        print("DEBUG: handle Profile Image Tapped")
    }
    ...
    @objc func handleCommentTapped() {
        print("DEBUG: handle Comment Tapped")
    }
    
    @objc func handleRetweetTapped() {
        print("DEBUG: handle Retweet Tapped")
    }
    ...
    @objc func handleShareTapped() {
        print("DEBUG: handle Share Tapped")
    }
